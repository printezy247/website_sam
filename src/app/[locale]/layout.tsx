...
const display = localFont({ src: "../fonts/anton.woff2", variable: "--font-anton", display: "swap", weight: "400" });
...
export default async function LocaleLayout({ children, params }: { children: React.ReactNode; params: Promise<{ locale: string }> }) {
  ...
  return (
    <html lang={locale} className={`${sans.variable} ${mono.variable} ${display.variable} h-full antialiased`}>
